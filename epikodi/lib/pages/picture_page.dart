...
import 'package:epikodi/pages/display_picture_page.dart';
...
class _PicturePageState extends State<PicturePage> {
  ...
  void saveafterdelete(String name) async {
    ...
    prefs.setString('picture_added', lastdata).then((bool success) {
      return;
    });
  }
  ...
  void _openFileExplorer() async {
    final SharedPreferences prefs = await _prefs;
    final String _pathsTM = prefs.getString('picture_added') ?? null;
    ...
    try {
      if (_multiPick) {
        ...
        setState(() {
          _pathsADD =
              prefs.setString('picture_added', _pf).then((bool success) {
          ...
          child: Row(children: <Widget>[
            ...
            Container(
              ...
              child: new RaisedButton(
                ...
                child: new Text("Add new pictures",
